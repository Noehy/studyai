    ...
    <>
      ...
      <div className="grid h-screen grid-cols-[260px_1fr]">
        ...
        <div className="flex flex-col overflow-hidden bg-gray-700">
          <div className="flex flex-1 flex-col-reverse no-scrollbar overflow-scroll text-white">
            ...
            <form onSubmit={handleSubmit}>
              <fieldset className="flex gap-2" disabled={generatingResponse}>
                <textarea
                  ...
                  className="w-full resize-none rounded-md bg-gray-700 p-2 text-white focus:border-blue-900 focus:bg-gray-600 focus:outline focus:outline-blue-900"
                />
